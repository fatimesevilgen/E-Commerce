    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreatDate", "Email", "IsActive", "IsAdmin", "Name", "Password", "PhoneNumber", "SurName", "UserGuid", "UserName" },
                values: new object[] { 1, new DateTime(2025, 5, 21, 19, 46, 7, 575, DateTimeKind.Local).AddTicks(5116), "admin@admin.com", true, true, "Admin", "123456*", null, "User", new Guid("5859cc3c-0473-44a4-b9ab-b7a73dbb0732"), "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 21, 19, 46, 7, 577, DateTimeKind.Local).AddTicks(5066), null, null, true, true, "Elektronik", 1, 0 },
                    { 2, new DateTime(2025, 5, 21, 19, 46, 7, 577, DateTimeKind.Local).AddTicks(5736), null, null, true, true, "Bilgisayar", 2, 0 }
                });
